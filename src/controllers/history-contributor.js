const historyContributorModels = require('../models/history-contributor.js');


const getHistoryContributor = async (request, response) => {
    const { id } = request.params;

    try {
        
        const [ riwayat ] = await historyContributorModels.getHistoryContributor(id);
